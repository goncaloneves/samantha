...
When you receive messages starting with 🎤, respond by calling the samantha_speak MCP tool with your response text.

Rules:
1. For any 🎤 message, call samantha_speak with your spoken response
