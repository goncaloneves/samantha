...
APP_ACTIVATION_TIMEOUT = 5
INJECTION_TIMEOUT = 10
SERVICE_SHUTDOWN_GRACE = 3
SYSTEM_PLAYER_TIMEOUT = 120
THREAD_READY_TIMEOUT = 30.0
FOCUS_POLL_TIMEOUT = 3.0
FOCUS_POLL_INTERVAL = 0.1
COMMAND_PALETTE_SETTLE = 0.4
MAX_REATTACH_ATTEMPTS = 10
REATTACH_BACKOFF_SECONDS = 1.0
